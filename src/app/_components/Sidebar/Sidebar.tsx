'use client'
import { Birdhouse, Telescope, Warehouse, ShoppingBag } from 'lucide-react';
  ...
  return (
    <nav className={sidebarClasses}>
      <ul className={styles.sideNav}>
        ...
        <li className={`${styles.sideNav__item} ${pathName === '/shop' ? styles.sideNav__item_active : ''}`}>
          <Link href="/shop" className={styles.sideNav__link}>
            <ShoppingBag color="#663300" />
            <span>Shop</span>
          </Link>
        </li>
      </ul>
